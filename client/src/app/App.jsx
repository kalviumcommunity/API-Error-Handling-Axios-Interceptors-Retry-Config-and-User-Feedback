...
const getThreads = () =>
  apiClient.get("/threads").then((r) => r.data);

const getFlaky = () =>
  apiClient.get("/flaky").then((r) => r.data);
...
export default function App() {
  ...
  // /flaky fails once then succeeds, so with retry: 1
  // you should see two requests, then success.

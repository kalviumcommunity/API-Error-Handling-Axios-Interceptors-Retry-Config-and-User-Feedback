...
const getThreads = () =>
  apiClient.get("/api/threads").then((r) => r.data);

const getFlaky = () =>
  apiClient.get("/api/flaky").then((r) => r.data);
...
export default function App() {
  ...
  // /api/flaky fails once, then succeeds.
  // With retry: 1, you should see two requests, then success.
    ...
    <main>
      ...
      <section className="tests">
        ...
        <div className="buttons">
          ...
          <button
            onClick={() => apiClient.get("/api/unauthorized")}
          >
            Trigger 401 (redirect to /login)
          </button>

          <button
            onClick={() => apiClient.get("/api/broken")}
          >
